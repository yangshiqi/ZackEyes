...
export const downloadBytes = 2889616;
export const downloadSize = '2.9 MB';
export const downloadSizeLabel = `${downloadSize} DMG`;
export const downloadBytesLabel = `${downloadBytes.toLocaleString('en-US')} bytes`;
export const downloadSha256 = '0583e2630643e857cfe41f1864378463f8353be98612f280195c1106d6deb51a';
